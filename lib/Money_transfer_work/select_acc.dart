import 'package:bank_sparks/Money_transfer_work/send_money.dart';
import 'package:bank_sparks/reciver.dart';
...
class SelectAccountPageState extends State<SelectAccountPage> {
  ...
  List<ReceiverModel> receivers = [
    ReceiverModel('Shivam', '0937110938', '1234 0000 0099 0909'),
    ReceiverModel('Arvind', '0937110938', '1234 0000 0099 0909'),
    ReceiverModel('Alok', '0937110938', '1234 0000 0099 0909'),
    ReceiverModel('Sandeep', '0937110938', '1234 0000 0099 0909'),
    ReceiverModel('Dheeraj', '0937110938', '5678 0000 0099 0909'),
  ];
