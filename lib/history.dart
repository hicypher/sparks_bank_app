...
class HistoryPageState extends State<HistoryPage> {
  List<HistoryModel> histories = [
    HistoryModel('images/ico_send_money.png', 'Paid to', 'Arvind', 500.0,
        '04 April 2020', 'images/ico_logo_red.png'),
    HistoryModel('images/ico_send_money.png', 'Paid to', 'Alok', 999.0,
    ...
    HistoryModel('images/ico_receive_money.png', 'Received from', 'Shivam', 30.0,
        '08 May 2018', 'images/ico_logo_blue.png'),
  ];
