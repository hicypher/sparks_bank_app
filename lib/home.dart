import 'package:bank_sparks/meanu.dart';
import 'package:bank_sparks/widget/bank_card.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';

import 'Money_transfer_work/select_acc.dart';
...
class HomePageState extends State<HomePage> {
  final List<BankCardModel> cards = [
    BankCardModel('images/bg_blue_card.png', 'Manish Sharma',
        '4221 5168 7464 2283', '08/20', 10000000),
    BankCardModel('images/bg_blue_circle_card.png', 'Manish Sharma',
        '4221 5168 7464 2283', '08/20', 10000000),
    BankCardModel('images/bg_purple_card.png', 'Manish Sharma',
        '4221 5168 7464 2283', '08/20', 10000000),
    BankCardModel('images/bg_red_card.png', 'Manish Sharma',
        '4221 5168 7464 2283', '08/20', 10000000),
  ];
